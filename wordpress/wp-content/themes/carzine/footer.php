        ...
        <div class="row">
            ...
            <div class="row">
                ...
                <?php else: ?>
                    ...
                    <?php printf( __( 'Carzine ', 'carzine' )); ?></a> Theme, Powered by WordPress and sponsored by <a href="<?php echo esc_url('https://www.sdm.gr'); ?>" target="_blank"><?php echo esc_html__('SDM - Digital Marketing Agency','carzine'); ?></a>
                    </p>
                <?php endif;?>
                </div>
            </div>
